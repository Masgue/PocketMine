...
public class Level {
    ...
    public Level(int currentExperience, int x, int y) {
    ...
    public void Add(int experience) {
        ...
        _currentLevel = _currentExperience / 10;
        _level.GetInteger().setValue(_currentLevel);
        _level.SetMovingBitmap(_currentExperience % 10);
    }

    public MovingBitmap GetBar() {
        return _level.GetMovingBitmap();
    }
